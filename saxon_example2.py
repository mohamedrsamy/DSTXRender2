...
with PySaxonProcessor(license=False) as proc:
    ...
    outputi = xsltproc.transform_to_string(source_file="/home/mohamed/PycharmProjects/DSTXRender/input/input.dstx", stylesheet_file="/home/mohamed/PycharmProjects/DSTXRender/parent.xslt")
    print("Test1 =",outputi)
